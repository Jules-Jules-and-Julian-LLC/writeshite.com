        ...
        return (
            <div>
                ...
                <div class="not-centered-text">
                    ...
                    story reaches its conclusion, players can click Complete Story to finish that story so it can't be
                    added to anymore.
                    <br /> <br />
                    This continues until either time is up, or every story has been completed, then the stories are read
                    aloud by each of you. Because of this, it's recommended to have some form of voice communication to
                    play. However, if you don't read the stories aloud they will also be shown in the lobby before
                    starting the next round.
                    <br /> <br />
                    <h2>Additional Info</h2>
                    Unless the host of the game opts out, all of the stories are saved to a{" "}
                    <span className="bold-text">public</span> gallery for each lobby. Don't write any personal
                    information or anything else you don't want public. I'm not responsible for the contents of any
                    stories or galleries. <br />
